...
val domainModule = module {
    ...
    factory { RunOcrOnPageUseCase(documentRepository = get(), imageRepository = get(), ocrEngine = get()) }
    factory { CreateDocumentUseCase(documentRepository = get(), imageRepository = get()) }
    ...
    factory { RenameDocumentUseCase(repository = get()) }
}
